...
MessageBox::MessageBox(QWidget *parent, const QString &title, const QString &text,
    ...
    : QDialog(parent)
{
    setWindowIcon(QIcon(":/new/prefix1/ico.png"));
    ...
    QPixmap pixmap(":/new/prefix1/vectory.jpg");
    m_pIconLabel->setPixmap(pixmap);
    m_pIconLabel->setFixedSize(300, 130);
                                            ...
                                            QMessageBox::StandardButton defaultButton)
{
    ...
    msgBox.setIcon(":/new/prefix1/vectory.jpg");
    if (msgBox.exec() == -1)
