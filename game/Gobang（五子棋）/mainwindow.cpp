...
void MainWindow::mousePressEvent(QMouseEvent *)   //鼠标按压后执行下棋操作
{
...
{
    if(game->Jude_win()==1){
      QSound::play(":/new/prefix1/res/sound/win.wav");
      QMessageBox::information(this,"游戏结束！","黑棋赢!");
      start_Game();
      update();
    }
    if(game->Jude_win()==-1){
       QSound::play(":/new/prefix1/res/sound/win.wav");
       QMessageBox::information(this,"游戏结束！","白棋赢!");      
       start_Game();
       update();
    }
